...
function showTab(tab) {
    ...
    // Add "active" to the target tab content and corresponding button
    ...
    // Use a more robust approach to activate the clicked button:
    document.querySelectorAll('.tab-button').forEach(button => {
      if (button.getAttribute("onclick") === `showTab('${tab}')`) {
